///************************************************
/// Generated by: Uyvq
/// Date: 24/08/2011 06:59:19
/// Goal: Create User Service Class for V_RPT_GD_BILL
///************************************************
/// <summary>
/// Create User Service Class for V_RPT_GD_BILL
/// </summary>
...
namespace SaleUS
{
    public class US_V_RPT_GD_BILL : US_Object
    {
        private const string c_TableName = "V_RPT_GD_BILL";
        ...
        public US_V_RPT_GD_BILL()
        {
            pm_objDS = new DS_V_RPT_GD_BILL();
            pm_strTableName = c_TableName;
            pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
        }

        public US_V_RPT_GD_BILL(DataRow i_objDR)
            : this()
        {
            this.DataRow2Me(i_objDR);
        }

        public US_V_RPT_GD_BILL(decimal i_dbID)
        {
            pm_objDS = new DS_V_RPT_GD_BILL();
            pm_strTableName = c_TableName;
