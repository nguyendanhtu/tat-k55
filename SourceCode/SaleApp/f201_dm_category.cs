///************************************************
/// Generated by: tund
/// Date: 15/08/2011 11:34:53
/// Goal: Create Form for DM_CATEGORY
///************************************************
...
namespace SaleApp
{
	...
	public class f201_dm_category : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.m_pnl_out_place_dm.Size = new System.Drawing.Size(705, 36);
            ...
            this.m_cmd_insert.Location = new System.Drawing.Point(349, 4);
            ...
            this.m_cmd_update.Location = new System.Drawing.Point(437, 4);
            ...
            this.m_cmd_delete.Location = new System.Drawing.Point(525, 4);
            ...
            this.m_cmd_exit.Location = new System.Drawing.Point(613, 4);
            ...
            this.m_fg.Name = "m_fg";
            this.m_fg.Size = new System.Drawing.Size(705, 275);
            ...
            this.Name = "f201_dm_category";
            this.Text = "F201- Danh mục nhóm hàng";
            this.Load += new System.EventHandler(this.f201_dm_category_Load);
...
,CATEGORY_NAME = 2
		...
		DS_DM_CATEGORY m_ds = new DS_DM_CATEGORY();
		US_DM_CATEGORY m_us = new US_DM_CATEGORY();
		#endregion
		...
		private void load_data_2_grid(){						
			m_ds = new DS_DM_CATEGORY();			
			m_us.FillDataset(m_ds);
			m_fg.Redraw = false;
			CGridUtils.Dataset2C1Grid(m_ds, m_fg, m_obj_trans);
			m_fg.Redraw = true;
		}
		private void grid2us_object(US_DM_CATEGORY i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_DM_CATEGORY i_us
			, int i_grid_row) {
		...
		private void insert_dm_category(){
            f202_dm_category_de v_fDE = new f202_dm_category_de();								
			v_fDE.display_for_insert();
			load_data_2_grid();
		}

		private void update_dm_category(){			
		...
		private void delete_dm_category(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			if (BaseMessages.askUser_DataCouldBeDeleted(8) != BaseMessages.IsDataCouldBeDeleted.CouldBeDeleted)  return;
			US_DM_CATEGORY v_us = new US_DM_CATEGORY();
		...
		private void view_dm_category(){			
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			grid2us_object(m_us, m_fg.Row);
		//	f201_dm_category_DE v_fDE = new f201_dm_category_DE();			
		//	v_fDE.display(m_us);
		}
...
//
		...
		//
		//
		private void f201_dm_category_Load(object sender, System.EventArgs e) {
			try{
