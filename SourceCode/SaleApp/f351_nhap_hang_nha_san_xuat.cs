...
namespace SaleApp
{
    public partial class f351_nhap_hang_nha_san_xuat : Form
    {
        // Constructor
        public f351_nhap_hang_nha_san_xuat()
        {
            InitializeComponent();
            format_control();
        }
        ...
        void f351_nhap_hang_nha_san_xuat_Load(object sender, EventArgs e)
        {
            try
            {
