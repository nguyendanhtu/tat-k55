///************************************************
/// Generated by: tund
/// Date: 19/08/2011 02:50:04
/// Goal: Create Form for DM_PROVIDER
///************************************************
...
namespace SaleApp
{
	...
	public class f701_dm_provider : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.m_pnl_out_place_dm.Location = new System.Drawing.Point(0, 419);
            ...
            this.m_cmd_insert.Location = new System.Drawing.Point(595, 4);
            ...
            this.m_cmd_update.Location = new System.Drawing.Point(683, 4);
            ...
            this.m_cmd_delete.Location = new System.Drawing.Point(771, 4);
            ...
            this.m_cmd_exit.Location = new System.Drawing.Point(859, 4);
            ...
            this.m_lbl_header.Size = new System.Drawing.Size(951, 66);
            this.m_lbl_header.TabIndex = 25;
            this.m_lbl_header.Text = "DANH MỤC NHÀ CUNG CẤP";
...
,ADDRESS = 5
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(DM_PROVIDER.MOBILE, e_col_Number.MOBILE);
			v_htb.Add(DM_PROVIDER.PROVIDER_NAME, e_col_Number.PROVIDER_NAME);
			v_htb.Add(DM_PROVIDER.PROVIDER_CODE, e_col_Number.PROVIDER_CODE);
			v_htb.Add(DM_PROVIDER.TAX_CODE, e_col_Number.TAX_CODE);
			v_htb.Add(DM_PROVIDER.EMAIL, e_col_Number.EMAIL);
			v_htb.Add(DM_PROVIDER.ADDRESS, e_col_Number.ADDRESS);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_ds.DM_PROVIDER.NewRow());
			return v_obj_trans;			
		}
		...
		private void grid2us_object(US_DM_PROVIDER i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_DM_PROVIDER i_us
			, int i_grid_row) {
		...
		private void insert_dm_provider(){
		...
		private void delete_dm_provider(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			if (BaseMessages.askUser_DataCouldBeDeleted(8) != BaseMessages.IsDataCouldBeDeleted.CouldBeDeleted)  return;
			US_DM_PROVIDER v_us = new US_DM_PROVIDER();
...
//
		...
		//
		//
		private void f701_DM_PROVIDER_Load(object sender, System.EventArgs e) {
			try{
