///************************************************
/// Generated by: tund
/// Date: 20/08/2011 05:11:52
/// Goal: Create Form for DM_REPOSITORY
///************************************************
...
namespace SaleApp
{
	...
	public class f801_dm_repository : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f801_dm_repository));
            ...
            this.m_lbl_header.Size = new System.Drawing.Size(686, 51);
            this.m_lbl_header.TabIndex = 24;
            this.m_lbl_header.Text = "DANH MỤC KHO";
		...
		DS_DM_REPOSITORY m_ds = new DS_DM_REPOSITORY();
		US_DM_REPOSITORY m_us = new US_DM_REPOSITORY();
		#endregion
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(DM_REPOSITORY.ADDRESS, e_col_Number.ADDRESS);			v_htb.Add(DM_REPOSITORY.REPOSITORY_NAME, e_col_Number.REPOSITORY_NAME);			v_htb.Add(DM_REPOSITORY.MOBILE, e_col_Number.MOBILE);			v_htb.Add(DM_REPOSITORY.REPOSITORY_CODE, e_col_Number.REPOSITORY_CODE);									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_ds.DM_REPOSITORY.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){						
			m_ds = new DS_DM_REPOSITORY();			
			m_us.FillDataset(m_ds);
			m_fg.Redraw = false;
			CGridUtils.Dataset2C1Grid(m_ds, m_fg, m_obj_trans);
			m_fg.Redraw = true;
		}
		private void grid2us_object(US_DM_REPOSITORY i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_DM_REPOSITORY i_us
			, int i_grid_row) {
		...
		private void update_dm_repository(){			
		...
		private void delete_dm_repository(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			if (BaseMessages.askUser_DataCouldBeDeleted(8) != BaseMessages.IsDataCouldBeDeleted.CouldBeDeleted)  return;
			US_DM_REPOSITORY v_us = new US_DM_REPOSITORY();
		...
		private void view_dm_repository(){			
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			grid2us_object(m_us, m_fg.Row);
...
//
		...
		//
		//
		private void f801_dm_repository_Load(object sender, System.EventArgs e) {
			try{
