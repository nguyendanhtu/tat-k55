///************************************************
/// Generated by: hungtd
/// Date: 19/08/2011 11:08:46
/// Goal: Create Form for DM_CUSTOMER
///************************************************
...
namespace SaleApp
{
    ...
    public class f501_dm_customer : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f501_dm_customer));
            ...
            this.m_lbl_header.Text = "DANH MỤC KHÁCH HÀNG";
            ...
            this.Name = "f501_dm_customer";
            this.Text = "F501 - Danh mục khách hàng";
            this.Load += new System.EventHandler(this.f501_dm_customer_Load);
        ...
        private void us_object2grid(US_DM_CUSTOMER i_us
            , int i_grid_row)
        {
        ...
        private void insert_dm_customer()
        {
            f502_dm_customer_de frm502 = new f502_dm_customer_de();
            frm502.display_for_insert();
            load_data_2_grid();
        }
        ...
        private void delete_dm_customer()
        {
            if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
            if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
            if (m_fg.Rows[m_fg.Row].IsNode == true) return;
        ...
        //
        //
        private void f501_dm_customer_Load(object sender, System.EventArgs e)
        {
            try
            {
